using Day10EmployeeParallelization.Utilities;
...
namespace Day10EmployeeParallelization.Pages
{
    public class EmployeePage
    {
        ...
        public void Edit_EmployeeRecord(IWebDriver driver1)
        {
            ...
            IWebElement EmployeeEdit = driver1.FindElement(By.XPath("//*[@id=\"usersGrid\"]/div[3]/table/tbody/tr[last()]/td[3]/a[1]"));
            EmployeeEdit.Click();
        ...
        {
            Thread.Sleep(1000);
            IWebElement EmployeeLastPage = driver.FindElement(By.XPath("//*[@id=\"usersGrid\"]/div[4]/a[4]/span"));
            EmployeeLastPage.Click();                                  
            IWebElement EmployeeDelete = driver.FindElement(By.XPath("//*[@id=\"usersGrid\"]/div[3]/table/tbody/tr[last()]/td[3]/a[2]"));
