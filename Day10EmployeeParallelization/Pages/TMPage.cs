...
namespace Day10EmployeeParallelization.Pages
{
    public class TMPage
    {
        ...
        public void Delete_TimeRecord(IWebDriver driver2) 
        {
           ...
           // IWebElement lastRecordElement = driver.FindElement(By.XPath("//*[@id=\"tmsGrid\"]/div[3]/table/tbody/tr[last()]/td[3]/a[2]"));

            // Get the text of the last record
            string lastRecordText = lastPageRecordDelete.Text;
